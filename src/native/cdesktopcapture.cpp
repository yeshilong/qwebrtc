                                          ...
                                          std::unique_ptr<webrtc::DesktopFrame> frame)
{
    ...
    std::shared_ptr<RTCVideoFrame> videoFrame =
        std::make_shared<RTCVideoFrame>(std::make_shared<RTCQImageBuffer>(image),
                                        RTCVideoRotation::RTCVideoRotation_0, timeStampNs);
